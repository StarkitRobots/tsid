...
#ifndef __invdyn_task_joint_mimic_hpp__
#define __invdyn_task_joint_mimic_hpp__
...
namespace tsid
{
  namespace tasks
  {
    ...
    class TaskJointMimic : public TaskMotion
    {
    public:
      ...
      typedef pinocchio::Model::JointIndex JointIndex;

      TaskJointMimic(const std::string & name,
                      RobotWrapper & robot,
    ...
    protected:
      ...
      JointIndex m_jointIndexMaster;
      JointIndex m_jointIndexSlave;
      float m_direction;
    };
