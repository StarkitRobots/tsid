...
#ifndef __invdyn_task_frames_mirror_hpp__
#define __invdyn_task_frames_mirror_hpp__
...
namespace tsid
{
  namespace tasks
  {
    ...
    class TaskTwoFramesMirror : public TaskMotion
    {
    public:
      ...
      TaskTwoFramesMirror(const std::string & name,
                      RobotWrapper & robot,
    ...
    protected:
      ...
      std::string m_frame_name_middle;
      Index m_frame_id1;
      Index m_frame_id2;
      Index m_frame_id_middle;
      ...
      SE3 m_wMl1, m_wMl2, m_wMlM;
      Vector m_Kp;
      Vector m_Kd;
      Vector m_a_des, m_a_des_masked;
      Motion m_drift;
      Vector m_drift_masked;
      Matrix6x m_J1, m_J2, m_JM;
      Matrix6x m_J1_rotated, m_J2_rotated, m_JM_rotated;
