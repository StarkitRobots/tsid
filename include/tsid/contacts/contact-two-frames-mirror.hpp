...
#ifndef __invdyn_contact_two_frames_mirror_hpp__
#define __invdyn_contact_two_frames_mirror_hpp__
...
namespace tsid
{
  namespace contacts
  {
    class ContactTwoFramesMirror : public ContactBase
    {
    public:
      ...
      typedef tasks::TaskTwoFramesMirror TaskTwoFramesMirror;
      typedef tasks::TaskSE3Equality TaskSE3Equality;
      typedef math::ConstraintInequality ConstraintInequality;
      typedef math::ConstraintEquality ConstraintEquality;
      typedef pinocchio::SE3 SE3;

      ContactTwoFramesMirror(const std::string & name,
                RobotWrapper & robot,
    ...
    protected:
      ...
      TaskTwoFramesMirror m_motionTask;
